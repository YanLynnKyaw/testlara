...
class StudentController extends Controller
{
    ...
    public function store(Request $request)
    {
        $request->validate([
            ...
            'student_image'         =>  'required|image|mimes:jpg,png,jpeg,gif,svg|max:2024|dimensions:min_width=100,min_height=100,max_width=1000,max_hight=1000'
    ...
    {
        $student->delete();
        return redirect()->route('student.index')->with('success','A Student data has been successfully deleted!');
    }
}
